...
public class Week2 {
    ...
    public static Scene getCreatedScene(boolean freePlay, int songNum){
        ...
        switch (songNum){
            case 0:
                noteSpeed = 1.8;
                BFChart = Charts.getBergentruckungBFChart();
                OpponentChart = Charts.getBergentruckungAsgoreChart();
                song = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/Bergentruckung/mus_bergentruckung.mp3"));
                voiceBF = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/Bergentruckung/Voices-bf.mp3"));
                voiceOpponent = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/Bergentruckung/Voices-asgore.mp3"));
                break;
            case 1:
                noteSpeed = 2.3;
                BFChart = Charts.getAsgoreBFChart();
                OpponentChart = Charts.getAsgoreAsgoreChart();
                song = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/ASGORE/mus_vsasgore.mp3"));
                voiceBF = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/Bergentruckung/Voices-bf.mp3"));
                voiceOpponent = new MediaPlayer(new Media(Main.class.getResource("") + "Sounds/Music/Bergentruckung/Voices-asgore.mp3"));
                break;
            default:
        ...
        AsgoreAnimated Opponent = new AsgoreAnimated(0);
        ...
        ImageView iconOpponent = new ImageView(new Image(Main.class.getResource("") + "Images/Icons/icon-asgore.png"));
        iconBF.setScaleX(-1);
        iconBF.setY(545);
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long l) {
                ...
                Opponent.getView().setX(700 - cameraPos[0] - Opponent.getFrameWidth() - Opponent.getXOffset());
                Opponent.getView().setY(700 - cameraPos[1] - Opponent.getFrameHeight() - Opponent.getYOffset());
        ...
        song.setOnEndOfMedia(() -> {
            ...
            try {
                Main.changeScore(4 + songNum, score);
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            if (!freePlay) {
